...
class TestCoreURLs(TestCase):
    ...
    def test_home_url_resolves(self):
        ...
        self.assertIsInstance(response.context['view'], views.HomeView)  # Check if the correct view is used
    ...
    def test_portfolio_url_resolves(self):
        ...
        self.assertTemplateNotUsed(response, 'portfolio.html')  # Check if the correct template is used
